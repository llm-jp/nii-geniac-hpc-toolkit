...
variable "network_self_link_sysnet" {
...
variable "subnetwork_self_link_gpunet0" {
  description = "Toolkit deployment variable: subnetwork_self_link_gpunet0"
  type        = string
}

variable "subnetwork_self_link_gpunet1" {
  description = "Toolkit deployment variable: subnetwork_self_link_gpunet1"
  type        = string
}

variable "subnetwork_self_link_gpunet2" {
  description = "Toolkit deployment variable: subnetwork_self_link_gpunet2"
  type        = string
}

variable "subnetwork_self_link_gpunet3" {
  description = "Toolkit deployment variable: subnetwork_self_link_gpunet3"
  type        = string
}
